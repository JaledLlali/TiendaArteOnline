...
<body>
	...
	<div class="container-fluid mt-4">
		<p class="display-4 text-center">Resultados de la búsqueda:</p>
		<?php
				for ($i=0; $i < count($productos); $i++) { 
					print '<div class="media">';
					print '<div class="media-left m-3">';
					print '<img src="img/'.$productos[$i]["imagen"].'" class="media-object" style="max-width: 200px;"/>';
					print '</div>';
					print '<div class="media-body">';
					print '<h4 class="media-heading"><a class="badge badge-light" href="producto.php?id='.$productos[$i]["id"].'">'.$productos[$i]["nombre"].'</a></h4>';
